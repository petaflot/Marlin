...
#define STRING_CONFIG_H_AUTHOR "(JCZD, Manta M8P / CR-Whale)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "killerwhale"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "181eac1f-b602-46ba-b71f-5cee954a0a2a"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  24.7394
    #define DEFAULT_Ki   1.9951
    #define DEFAULT_Kd  76.6922
  #endif
#else
 ...
 */
#define MAX_BED_POWER 200 // limits duty cycle to bed; 255=full current (blows 15A fuse after a while)
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 103.7845
  #define DEFAULT_bedKi 18.5329
  #define DEFAULT_bedKd 387.4622
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 180, 20, 120 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 50, 160 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 7000, 2300, 300, 6000 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 12000, 10000, 600, 15000 } // ...or, set your own edit limits
#endif
...
//#define CLASSIC_JERK
  ...
  #define TRAVEL_EXTRA_XYJERK 4.0     // Additional jerk allowance for all travel moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -28, 0, -0.66 }
...
// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
  ...
  #define Y_MIN_POS 0
  #define Z_MIN_POS 0
  #define X_MAX_POS X_BED_SIZE + 18 // could be 20
  #define Y_MAX_POS Y_BED_SIZE
#else
  #define X_MIN_POS -X_BED_SIZE/2
  #define Y_MIN_POS -Y_BED_SIZE/2
  #define Z_MIN_POS 0
  #define X_MAX_POS X_BED_SIZE/2 + X_BED_SIZE%2
  #define Y_MAX_POS Y_BED_SIZE/2 + Y_BED_SIZE%2
#endif
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_STATE     HIGH       // Pin state indicating that filament is NOT present (HIT_STATE).
  ...
  //#define FILAMENT_RUNOUT_SCRIPT "M600"//"G28 XY 0\nM600" as per https://www.reddit.com/r/MarlinFirmware/comments/16na2wg/orbiter_filament_sensor_config_guide_full_marlin/
...
#define STARTUP_TUNE { 261, 370,       0, 30,  349, 300,       0, 100, 440, 300,       0, 100, 523, 575,       0, 25,  447, 250,       523, 750}
